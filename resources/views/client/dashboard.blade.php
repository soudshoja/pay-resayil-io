    ...
    <div class="glass-card rounded-xl p-6 mb-6">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-bold text-white">Resayil WhatsApp Dashboard</h2>
                    <p class="text-gray-400 text-sm mt-1">Manage your WhatsApp conversations and automation</p>
                </div>
            </div>
            <a href="https://wa.resayil.io/"
               target="_blank"
               rel="noopener noreferrer"
               class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-green-500/25">
                <span>Open WhatsApp Dashboard</span>

...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-400">Transactions from my agents ({{ $transactions->total() }})</p>
        </div>
        <a href="{{ route('sales.transactions.export', request()->query()) }}" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                ...
                <tbody class="divide-y divide-gray-800">
                    @forelse($transactions as $payment)
                        <tr class="hover:bg-dark-800/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-300">{{ $payment->agent?->company_name ?: '-' }}</td>

...
@section('title', __('messages.common.add') . ' ' . __('messages.nav.accountants'))
...
<div class="max-w-xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-white">{{ __('messages.common.add') }} {{ __('messages.nav.accountants') }}</h1>
    </div>

    <!-- Form -->
    <div class="glass-card rounded-xl p-6">
        <form action="{{ route('client.accountants.store') }}" method="POST" class="space-y-6">
            @csrf

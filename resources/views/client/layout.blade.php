    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed inset-y-0 start-0 z-50 w-64 bg-dark-800 border-e border-gray-800 transform transition-transform duration-300"
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('client.keywords') }}"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-xl text-gray-300 hover:text-white hover:bg-gray-800/50 {{ request()->routeIs('client.keywords*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"/>
                    </svg>
                    <span>{{ __('messages.nav.keywords') }}</span>
                </a>
